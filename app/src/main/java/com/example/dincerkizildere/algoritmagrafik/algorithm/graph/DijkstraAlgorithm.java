...
public class DijkstraAlgorithm extends Algorithm implements DataHandler {

    private WeightedGraph2 graph;

    private WeightedGraphVisualizer2 visualizer;

    public DijkstraAlgorithm(WeightedGraphVisualizer2 visualizer, Activity activity, LogFragment logFragment) {
